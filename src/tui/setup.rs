...
use crate::actions::{
  buildlike::BuildAction,
  packlike::PackAction,
  deploylike::DeployAction,
...
impl DescribedAction {
  ...
  pub fn prompt_setup_for_project(
    ...
    let action = match &self.action {
      ...
      Action::Interrupt | Action::Patch(_) | Action::UseFromStorage(_) | Action::AddToStorage(_) | Action::SyncToRemote(_)  | Action::SyncFromRemote(_) => self.action.clone(),
    };
