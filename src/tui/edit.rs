...
impl DescribedAction {
  pub(crate) fn edit_action_from_prompt(&mut self) -> anyhow::Result<()> {
    ...
    match &self.action {
      ...
      Action::Interrupt | Action::ForceArtifactsEnplace | Action::UseFromStorage(_) | Action::SyncToRemote(_) | Action::SyncFromRemote(_) => {},
    }
      ...
      match action {
        ...
        i18n::EDIT_COMMANDS => {
          match &mut self.action {
            ...
            Action::Interrupt | Action::ForceArtifactsEnplace | Action::Patch(_) | Action::UseFromStorage(_) | Action::AddToStorage(_) | Action::SyncToRemote(_) | Action::SyncFromRemote(_) => {},
          }
        },
